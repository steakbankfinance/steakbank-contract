...
contract StakeBankImpl is Context, Initializable, ReentrancyGuard {
    ...
    function acceptAdmin() external {
        require(msg.sender == pendingAdmin, "StakeBank::acceptAdmin: Call must come from pendingAdmin.");
        admin = msg.sender;
    ...
    function setPendingAdmin(address pendingAdmin_) external {
        require(msg.sender == admin, "StakeBank::setPendingAdmin: Call must come from admin.");
    ...
    function stake(uint256 amount) notContract nonReentrant mustInMode(NORMAL_PERIOD) whenNotPaused external payable returns (bool) {
        ...
        require(amount%1e10==0 && amount>=MINIMUM_STAKE_AMOUNT, "stake amount must be N * 1e10 and greater than MINIMUM_STAKE_AMOUNT");
