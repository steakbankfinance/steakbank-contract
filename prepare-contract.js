...
program.option("-t, --template <template>", "StakeBNBAgent template file", "./contracts/StakeBNBAgent.template");
program.option("-o, --output <output-file>", "StakeBNBAgent.sol", "./contracts/StakeBNBAgent.sol")
